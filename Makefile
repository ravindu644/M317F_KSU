...
ARCH		?=arm64
CROSS_COMPILE	?= /home/galaxieo/Kernel/M317F_KSU/toolchain/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC              = /home/galaxieo/Kernel/M317F_KSU/toolchain/clang/host/linux-x86/clang-4639204/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /home/galaxieo/Kernel/M317F_KSU/toolchain/clang/host/linux-x86/clang-4639204/bin/aarch64-linux-gnu-
